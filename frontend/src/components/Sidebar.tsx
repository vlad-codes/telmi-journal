    ...
    <aside className="glass-sidebar w-60 shrink-0 flex flex-col h-full z-10">
      ...
      <div className="px-3 pb-2 shrink-0 flex items-center gap-1.5">
        <button
          ...
          className="flex-1 rounded-xl px-3 py-2 text-[13px] font-medium
        ...
        <button
          ...
          aria-label="What Telmi remembers"
          title="What Telmi remembers"
          className="w-8 h-8 shrink-0 flex items-center justify-center rounded-lg
                     text-[14px] leading-none
                     text-slate-400 dark:text-slate-500
                     hover:text-slate-600 dark:hover:text-slate-300
